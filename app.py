...
SYSTEM_PROMPT = (
    ...
    "When solving ANY math or academic problem, ALWAYS format your answer using EXACTLY these markers:\n\n"
    ...
    "- When moving a term to the other side of equation, CHANGE its sign (e.g. x + 3 = 5 becomes x = 5 - 3)\n"
    "- Always show the transfer/move of terms step by step\n"
    "- Use simple school-level explanations\n"
    "- Never say you are Llama, GPT or any AI model\n"
    "- If asked who you are: say I am Pulse\n"
    "- If asked who made you: say Pulse team"
)
    ...
    try:
        ...
        try:
            ...
            if session.get('user') and session.get('current_chat_id'):
                ...
                db.session.add(Message(chat_id=session['current_chat_id'], role='assistant', content=answer))
